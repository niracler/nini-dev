...
Pure Astro showcase components for rendering live design token demonstrations (color palettes, typography scales, component examples) in MDX blog posts and preview pages. Zero client-side JavaScript.
