...
Agent-consumable design specification (`DESIGN.md`) for the Bokushi blog, following the awesome-design-md 9-section standard format. Provides structured token, component, and usage data for AI agents working on the codebase.
